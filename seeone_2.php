...
$sql_str = "select* from user_info where user_name='$meet_account';";
$sql_repetition="select count(*) from attention where attention=(select user_account from user_info where user_name='$meet_account') and user_account='$x_account';";
